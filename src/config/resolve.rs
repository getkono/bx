...
/// cannot hold; for two enabled plugins that claim the terminal slot;
/// for two ready targets that name one file; and for an external whose
/// checkout overlaps another external's or a ready target's path.
